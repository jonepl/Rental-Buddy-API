...
def test_sales_success_returns_paginated_response(
    make_listing, stub_listings_service_factory
):
    listings = [
        make_listing("1", 300000, 3, 2.0, 1400, 30.001, -97.001, "A", category="sale"),
        make_listing("2", 350000, 4, 3.0, 2000, 30.01, -97.01, "B", category="sale"),
    ]
